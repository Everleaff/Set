...
public class Set {
    ...
    public static void main(String[] args) {
        ...
        set.printSet();  // Вывод: 2 3 4 5

        // Проверяем наличие элемента в множестве
        System.out.println(set.contains(3));  // Вывод: true
        System.out.println(set.contains(1));  // Вывод: false

        // Удаляем элемент из множества
        set.remove(3);
        set.remove(1);  // Ничего не произойдет, так как элемента нет в множестве

        // Выводим содержимое множества после удаления
        set.printSet();  // Вывод: 2 4 5
    }
}
